...
SECRET_KEY = JWT_SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY", "django-insecure-3ldc%sx81^0uurd4%956l++wde2460&vbpg7em*=*^1pfz*$sq"
)
...
if len(sys.argv) > 0 and sys.argv[1] != "collectstatic":  # DigitalOcean requirement
    DATABASES = {
        "default": dj_database_url.parse(
            os.environ.get("DATABASE_URL", "postgresql://postgres:root@localhost:5432/postgres")
        )
    }
...
SEND_CONFIRMATION_SMS = os.environ.get("SEND_CONFIRMATION_SMS") == 'True'
